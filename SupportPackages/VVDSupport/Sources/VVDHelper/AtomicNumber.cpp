...
extern "C" int32_t VVDAtomicNumber32_Increment(VVDAtomicNumber32* atomic)
{
    int32_t value;
#ifdef _WIN32
...
extern "C" int32_t VVDAtomicNumber32_Decrement(VVDAtomicNumber32* atomic)
{
    int32_t value;
#ifdef _WIN32
...
extern "C" int32_t VVDAtomicNumber32_Add(VVDAtomicNumber32* atomic, int32_t addend)
{
    int32_t value;
#ifdef _WIN32
...
extern "C" int32_t VVDAtomicNumber32_Exchange(VVDAtomicNumber32* atomic, int32_t value)
{
    int32_t prev;
#ifdef _WIN32
...
extern "C" bool VVDAtomicNumber32_CompareAndSet(VVDAtomicNumber32* atomic, int32_t comparand, int32_t value)
{
#ifdef _WIN32
...
extern "C" int32_t VVDAtomicNumber32_Value(VVDAtomicNumber32* atomic)
{
    return atomic->value;
}

extern "C" int64_t VVDAtomicNumber64_Increment(VVDAtomicNumber64* atomic)
{
    int64_t value;
#ifdef _WIN32
...
extern "C" int64_t VVDAtomicNumber64_Decrement(VVDAtomicNumber64* atomic)
{
    int64_t value;
#ifdef _WIN32
...
extern "C" int64_t VVDAtomicNumber64_Add(VVDAtomicNumber64* atomic, int64_t addend)
{
    int64_t value;
#ifdef _WIN32
...
extern "C" int64_t VVDAtomicNumber64_Exchange(VVDAtomicNumber64* atomic, int64_t value)
{
    int64_t prev;
#ifdef _WIN32
...
extern "C" bool VVDAtomicNumber64_CompareAndSet(VVDAtomicNumber64* atomic, int64_t comparand, int64_t value)
{
#ifdef _WIN32
...
extern "C" int64_t VVDAtomicNumber64_Value(VVDAtomicNumber64* atomic)
{
    return atomic->value;
}
