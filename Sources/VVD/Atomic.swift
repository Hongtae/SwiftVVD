...
public class AtomicNumber32 {
    private var atomic = VVDAtomicNumber32()
    public init(_ value: Int32 = 0) {
        atomic.value = value
    }
    @discardableResult
    public func increment() -> Int32 { VVDAtomicNumber32_Increment(&atomic) }
    @discardableResult
    public func decrement() -> Int32 { VVDAtomicNumber32_Decrement(&atomic) }

    public func add(_ addend: Int32) -> Int32 {
        VVDAtomicNumber32_Add(&atomic, addend)
    }
    public func exchange(_ value: Int32) -> Int32 {
        VVDAtomicNumber32_Exchange(&atomic, value)
    }
    public func compareAndSet(comparand: Int32, newValue: Int32) -> Bool {
        VVDAtomicNumber32_CompareAndSet(&atomic, comparand, newValue)
    }
    public func load() -> Int32 {
        var value = VVDAtomicNumber32_Value(&atomic)
        while VVDAtomicNumber32_CompareAndSet(&atomic, value, value) == false {
            value = VVDAtomicNumber32_Value(&atomic)
        }
        return value
    }
    ...
    public var value: Int32 { VVDAtomicNumber32_Value(&atomic) }
}

public class AtomicNumber64 {
    private var atomic = VVDAtomicNumber64()
    public init(_ value: Int64 = 0) {
        atomic.value = value
    }
    @discardableResult
    public func increment() -> Int64 { VVDAtomicNumber64_Increment(&atomic) }
    @discardableResult
    public func decrement() -> Int64 { VVDAtomicNumber64_Decrement(&atomic) }

    public func add(_ addend: Int64) -> Int64 {
        VVDAtomicNumber64_Add(&atomic, addend)
    }
    public func exchange(_ value: Int64) -> Int64 {
        VVDAtomicNumber64_Exchange(&atomic, value)
    }
    public func compareAndSet(comparand: Int64, newValue: Int64) -> Bool {
        VVDAtomicNumber64_CompareAndSet(&atomic, comparand, newValue)
    }
    public func load() -> Int64 {
        var value = VVDAtomicNumber64_Value(&atomic)
        while VVDAtomicNumber64_CompareAndSet(&atomic, value, value) == false {
            value = VVDAtomicNumber64_Value(&atomic)
        }
        return value
    }
    ...
    public var value: Int64 { VVDAtomicNumber64_Value(&atomic) }
}
...
private func setThreadWaiting(target: UInt) {
    let threadId: UInt = VVDThreadCurrentId()
